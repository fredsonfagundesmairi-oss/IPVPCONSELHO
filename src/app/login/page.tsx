          ...
          <div>
            ...
            <div className="relative mt-1">
              <input
                ...
                required
                className="block w-full px-4 py-3 bg-slate-50 border border-slate-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-black pr-12"
                value={password}
              ...
              >
                {showPassword ? (
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12.113a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                )}
              </button>
            </div>
